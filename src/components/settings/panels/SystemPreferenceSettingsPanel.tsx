...
interface SystemPreferenceSettingsPanelProps {
  onNotification: (msg: { text: string; type: "success" | "error" }) => void;
}

export const SystemPreferenceSettingsPanel: FC<SystemPreferenceSettingsPanelProps> = ({
  onNotification,
}) => {
  ...
  const [autoExportWeeklyScorecard, setAutoExportWeeklyScorecard] = useState(true);
  ...
  return (
    <div className="settings-panel-scroll">
      ...
      <div className="settings-panel-header-block">
        <div>
          <h2 className="settings-panel-heading flex items-center gap-2">
            ...
            <span>System & Regional Preferences</span>
          </h2>
          <p className="settings-panel-subheading">
            Configure calendar week start day, time display format, default post-login landing view, and report export settings
          </p>
        </div>
      </div>
      ...
      <div className="settings-card">
        ...
        <div className="settings-form-grid-3">
          <div className="settings-form-field">
            ...
            >
              <option value="Sunday">Sunday (Amazon Standard)</option>
      ...
      {/* 2. Default Landing Page Preference */}
      <div className="settings-card">
        <div className="settings-card-title-row">
          <h3 className="settings-card-title">
        ...
        <div className="settings-form-field max-w-md">
          ...
          >
            ...
            <option value="performance">Performance & Scorecard (/performance)</option>
      ...
      <div className="settings-card">
        <div className="settings-card-title-row">
          <h3 className="settings-card-title">
            ...
            <span>Data Export & Report Formatting</span>
          </h3>
        </div>
        <p className="settings-card-desc">
          Define standard file format and column preferences for roster and scorecard downloads.
        </p>
        ...
        <div className="settings-toggle-row mt-1">
          <div className="settings-toggle-info">
            <span className="settings-toggle-title">Automated Scorecard File Backup</span>
            <span className="settings-toggle-desc">
              Automatically saves an archive copy of each week's final scorecard export
            </span>
          </div>
          <label className="custom-blue-switch" title="Toggle auto-backup">
            <input
              type="checkbox"
              checked={autoExportWeeklyScorecard}
              onChange={() => setAutoExportWeeklyScorecard(!autoExportWeeklyScorecard)}
            />
      ...
      <div className="settings-footer-actions">
        ...
        >
          ...
          <span style={{ color: "#FFFFFF" }}>{isSaving ? "Saving..." : "Save Preferences"}</span>
        </button>
      </div>
    </div>
  );
...
export default SystemPreferenceSettingsPanel;
